...
var Router = function () {
  ...
  Router.prototype._onContributeCatchAllRoute = function _onContributeCatchAllRoute(r) {
    var _this = this;
...
var PluginRegistrationStore = function () {
  ...
  function PluginRegistrationStore(riotControlStore) {
  ...
  PluginRegistrationStore.prototype._unregisterPlugin = function _unregisterPlugin(registration) {
    ...
    if (foundRegistration === null) {
      ...
      for (var _i3 = 0; _i3 < foundRegistration.stores.length; _i3++) {
        this.riotControlStore._onRemove(foundRegistration.stores[_i3].name);
...
var P7HostCore = function () {
  ...
  P7HostCore.prototype.Initialize = function Initialize() {
    ...
    this._pluginRegistrationStore = new _pluginRegistrationStore2.default(this._riotControlStore);
