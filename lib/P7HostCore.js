...
})(this, function(__WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_20__, __WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_23__) {
...
var FetchStore = function () {
  ...
  FetchStore.prototype._readCookie = function _readCookie(name) {
    name += '=';
  ...
  FetchStore.prototype._onFetch = function _onFetch(input, init, ack) {
    ...
    // we are a json shop
    var token = this._readCookie('XSRF-TOKEN');
